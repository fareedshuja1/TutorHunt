<?php
    ...
    $result = $result_data->warning_msg_detail;
    } 
?>
...
<!--main content start-->
      ...
      <section class="panel">
          ...
          <header class="panel-heading"> <strong> This message will be shown to students while purchasing tutor's contact details. </strong></header>
          
          <div class="panel-body">
              
              <form role="form" action="<?php echo base_url();?>WebAdmin/warning_msg_paypal_payment_query" method="post">
