 ...
 ?>
	...
	<div class="container">
		   ...
		   <div class="candidates-item candidates-single-item">						
                   <h5><strong>Add Working Experience</strong></h5>
                    <hr>
                 <form class="form-inline" method="post" action="<?=base_url();?>Tutor_Controller/Tutor_Add_Experience_Query">

                    <div class="row">
                        
                        <div class="col-sm-4">
                        <label for="email">Job Title:</label> <br>
                        <input type="text" class="form-control" name="job_title" placeholder="Android App Developer">
                        </div>  
                     ...
                     <input type="text" class="form-control" name="years_experience" onkeypress='return isNumberKey(event)'>
                     </div>
                     ...
                     <input type="text" class="form-control" name="employer_name" style="width: 100%;">
                     </div>
                     ...
                     <textarea name="job_description" style="width:100%;" class="form-control"></textarea>
                     </div>
                    ...
                    <div class="row">
                        ...
                        <button type="submit" class="btn btn-info" id="" name="">Add Experience</button> &nbsp;
