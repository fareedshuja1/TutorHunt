	...
	<div class="container">
          ...
          <td style="background-color: #a9d622;"><div align="center"><img src="<?=base_url(); ?>images/id-verify.png" alt="ID Verified."></div></td>
		   ...
		   <div class="candidates-item candidates-single-item">						
                   <h5><strong>Add Reference</strong></h5>
                    <hr>
                 <form class="form-inline" method="post" action="<?=base_url();?>Tutor_Controller/Tutor_Add_Reference_Query">

                    <div class="row">
                        
                        <div class="col-sm-4">
                        <label for="email">First Name:</label> <br>
                        <input type="text" class="form-control" name="ref_fname">
                        </div>  
                                                
                                                 
                        <div class="col-sm-4">
                        <label for="email">Last Name:</label> <br>
                        <input type="text" class="form-control" name="ref_lname">
                        </div>
                     ...
                     <input type="text" class="form-control" name="ref_phone" onkeypress='return isNumberKey(event)'>
                     </div>
                    ...
                    <div class="row">
                        ...
                        <button type="submit" class="btn btn-info" id="" name="">Add Reference</button> &nbsp;
