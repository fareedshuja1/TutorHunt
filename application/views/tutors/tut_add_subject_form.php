 ...
 ?>
	...
	<div class="container">
		   ...
		   <div class="candidates-item candidates-single-item">						
                   <h5><strong>Add the subject which you want to teach</strong></h5>
                    <hr>
                 <form class="form-inline" method="post" action="<?=base_url();?>Tutor_Controller/tutor_addSubjuect_query">
                    ...
                    <div class="row">
                     ...
                     <label for="email">Rate / Hour:</label> <br>
                     <input type="text" class="form-control" name="rate_per_hour" required="required" onkeypress='return isNumberKey(event)'>
                     </div>
                         
                         
                     <div class="col-sm-9 singup-form2">
                     <label for="email">Select Levels:</label> <br>
                    
                        <?php
                         foreach ($subj_level as $sl)
                         {
                         //echo "<option value='$sl->sub_level_id'>$sl->sub_level_title</option>";
                     ...
                     <label for="email">Any Notes:</label> <br>
                         <textarea name="tut_sub_notes"></textarea>
                     </div>
